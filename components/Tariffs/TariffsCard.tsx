...
export const TariffsCard = ({ id, img, name, price, description, extraPrice, modalElement }: Props) => {
  ...
  return (
    <article
      ...
      className="max-w-[377px] w-full h-[697px] rounded-[30px] p-[36px_32px] relative box-border shadow-[0_0_31.1px_13px_rgba(0,179,220,0.11)_inset_0_0_0_1px_#00B3DC] tariff-item flex flex-col"
    >
      ...
      <Box className="tariff-description max-w-[313px]">
      ...
      <Box className="mt-auto">
        <Box
          className="tarrif-price mb-[29px] text-center block font-semibold not-italic bg-gradient-to-r from-[#FFDC00] via-[#FCD246] to-[#FFDC00] bg-clip-text text-transparent"
          data-price={price}
          data-currency="UAH"
        >
